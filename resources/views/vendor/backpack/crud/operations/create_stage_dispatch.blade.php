                                        ...
                                        <table class="table table-striped m-0 p-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            {{ $credit_control_stage->process_id }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            {{ $credit_control_stage->special_conditions == 1 ? 'Yes' : 'No' }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            {{ $credit_control_stage->user->name }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span data-order="{{ $credit_control_stage->created_at }}">
                                                            {{ $credit_control_stage->created_at }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span data-order=" {{ $credit_control_stage->updated_at }}">
                                                            {{ $credit_control_stage->updated_at }}
                                                        </span>
                                                    </td>
                                                </tr>
